...
| 5 fix batches | **batch 1 done (PR #164); batches 2–8 pending** |
...
| 149 | CSV-created category missing from transaction detail and Settings → Categories | P1 | Import/Export | 02 | 2 |
| 150 | Category search matches the stored English key, not the localised name | P1 | Categories | 03 | 2 |
| 153 | Category icons fall back to a generic glyph in trends and the list filter | P2 | Categories | 08 | 2 |
