...
- Snapshot refresh is triggered from exactly these `TransactionActor` methods, and no others: `add`, `addBatch`, `update`, `delete`, `addRecurrenceRule`, `updateRecurrenceRule`, `deleteOccurrences`, `materializeOccurrences`.
